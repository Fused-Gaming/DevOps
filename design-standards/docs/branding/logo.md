...
- [View in Penpot](https://penpot.vln.gg) *(coming soon)*
...
Before publishing materials with VLN logo, complete this checklist:

- [ ] Using official logo file from repository
- [ ] Logo sized at or above minimum (32px height)
- [ ] Clear space maintained (logo height ÷ 2 on all sides)
- [ ] Correct colors from VLN palette (#86d993 sage or #f8f9fa white)
- [ ] High contrast background (WCAG AAA — 7:1 or higher)
- [ ] Aspect ratio locked, no distortion or skewing
- [ ] Alt text included (for web usage)
- [ ] No unauthorized effects (shadows, glows, outlines)
- [ ] Not placed on busy or complex backgrounds
- [ ] Current version of logo used (not outdated files)

### Requesting Review

For major campaigns or partnership materials:
- Email: brand@vln.gg
